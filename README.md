...
In this episode I put the finishing touches on the Noun object by adding a hand-drawn 'puff' animation to its materializes/dematerialize sequences. Then I rig up that puff animation so that its playback and timing are controlled by the code-based tweens that are already in place. "Tween, meet your long-lost father, In-Between..."
